...
namespace EpitomelHotel.Controllers
{
    public class GuestsController : Controller
    {
        ...
        {
            var epitomelHotelDbContext = _context.Guest.Include(g => g.Address);
        ...
        public async Task<IActionResult> Create([Bind("GuestId,Firstname,Lastname,Email,Phone,AddressID")] Guest guest)
        {
            ...
            ViewData["AddressID"] = new SelectList(_context.Set<Address>(), "AddressID", "AddressID", guest.AddressID);
            return View(guest);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GuestId,Firstname,Lastname,Email,Phone,AddressID")] Guest guest)
        {
            if (id != guest.GuestId)
            {
                return NotFound();
