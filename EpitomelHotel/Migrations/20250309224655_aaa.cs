        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Guest_Address_AddressID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BookingService_Guest_GuestID",
                        column: x => x.GuestID,
                        principalTable: "Guest",
                        principalColumn: "GuestId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingService_Payments_PaymentsPaymentID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingService_PaymentsPaymentID",
                table: "BookingService",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_BookingServiceID",
                table: "Services",
                column: "BookingServiceID");

            migrationBuilder.CreateIndex(
                name: "IX_Services_GuestId",
                table: "Services",
                column: "GuestId");
        }
